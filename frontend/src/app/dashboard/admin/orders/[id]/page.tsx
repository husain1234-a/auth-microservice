...
export default function AdminOrderDetailPage({ params }: { params: { id: string } }) {
    ...
    const { state, fetchOrder, updateOrderStatus, assignDeliveryPartner } = useOrder();
    ...
    const handleAssignDeliveryPartner = async () => {
        if (!state.currentOrder || !deliveryPartnerId) return;

        try {
            setLoading(true);
            await assignDeliveryPartner(state.currentOrder.id, deliveryPartnerId);
            setDeliveryPartnerId('');
        } catch (err) {
            console.error('Failed to assign delivery partner:', err);
            setError('Failed to assign delivery partner. Please try again later.');
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">You need admin privileges to view order details.</p>
                                ...
                                <div>
                                    ...
                                    <div className="flex space-x-2">
                                        ...
                                        <button
                                            ...
                                            disabled={loading || !deliveryPartnerId}
